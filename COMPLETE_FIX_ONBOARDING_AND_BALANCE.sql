-- ============================================================================
-- COMPLETE FIX: Onboarding Functions + Balance Column
-- ============================================================================
-- Run this in Supabase SQL Editor to fix:
-- 1. 404 error: mark_onboarding_step_complete function not found
-- 2. Balance not showing: points vs points_balance column mismatch
-- ============================================================================

-- ============================================================================
-- PART 1: FIX BALANCE COLUMN NAME
-- ============================================================================
...
-- ============================================================================
-- PART 2: UPDATE SIGNUP BONUS TRIGGER TO USE points_balance
-- ============================================================================
...
-- ============================================================================
-- PART 3: CREATE ONBOARDING TABLES AND FUNCTIONS
-- ============================================================================
...
DO $$
BEGIN
  RAISE NOTICE '✅ Onboarding progress table created';
END $$;
...
BEGIN
  ...
  -- Calculate completion percentage (5 steps total, 20% each)
  SELECT
  ...
  -- Check if profile is completed (minimum: profile_picture + bio)
  ...
  IF all_completed THEN
    ...
    WHERE id = p_user_id
    AND onboarding_completed = false; -- Only update if not already completed
  END IF;
...
DO $$
BEGIN
  RAISE NOTICE '✅ mark_onboarding_step_complete function created';
END $$;
...
DO $$
BEGIN
  RAISE NOTICE '✅ get_user_onboarding_progress function created';
END $$;
...
BEGIN
  ...
  IF test_user_id IS NOT NULL THEN
    ...
    SELECT mark_onboarding_step_complete(test_user_id, 'profile_picture') INTO test_result;
...
-- Show sample user points
SELECT
  'Sample User Points' as check_type,
